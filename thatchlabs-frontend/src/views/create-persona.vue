		...
		<div class="pt-5 px-4">
					...
					<div class="flex flex-row mt-10">
						<div class="nft-list">
							<div class="flex flex-row gap-3 items-center">
								...
								<div class="w-full">
									<input type="text" v-model="vv.persona_name.$model" placeholder="Enter Gang Name" class="py-4 px-6 bg-gray-100 w-full rounded-full border-2 border-black" name="">
									<span class="error">{{ vv?.persona_name?.$errors[0]?.$message }}</span>
								</div>
							</div>
							<div class="flex flex-row gap-3 items-center mt-10">
								<div class="w-44">
									<h5 class="font-semibold">IMAGE STYLE</h5>
								</div>
								<div class="w-full">
						...
						<div class="w-56 pl-5 ml-14 flex flex-col item-center">
							<button class="shadow py-4 py-2 bg-black text-white rounded-full" style="width: 130px; height: 50px;" @click="processSelectedGang" :class="vv.$invalid ? 'bg-black-500' : 'bg-black'" :disabled="vv.$invalid">Create</button>
						</div>	
					</div>
				</form>
			</div>
			<div v-if="currentPage === 'confirm'">
				<div class="grid grid-cols-2">
		        	<div class="pl-4 pt-5">
		                <div class="bg-white py-10 px-5 shadow rounded flex flex-col items-center text-center mx-auto" style="max-width: 350px; height: auto; min-width: 350px;">
		                	...
		                	<h4 class="text-gray-700 text-xl font-semibold mt-3">BASE NFTs</h4>
				...
				<div class="grid">
		        	<div class="pl-4 pt-5 mt-5 flex flex-row ">
		                <div class="bg-white py-10 px-5 shadow-md rounded flex flex-col items-center text-center" style="max-width: 350px; height: auto; min-width: 350px;">
		                	<img src="../assets/nft2.png" class="rounded mt-2 mb-7" style="width: 150px; height: 150px;">
		                	<h5 class="font-extrabold text-xl">CREW/ DUSTY YETI</h5>
		                	<h5 class="font-extrabold text-xl"># 4372</h5>
		                	<h4 class="text-gray-700 text-xl font-semibold mt-3">MINT</h4>
		                	<h4 class="text-sm font-semibold mb-2 w-full break-words">https://www.solaneyes.com/address/2AaVEa5UMv8L5qfvrRryq5vRcsoVUaUuJrr9riHd1VxT?cluster=devnetCommand</h4>
		                </div>
		        	</div>
		        </div>
